    ...
    .then((profesionales) => {
      profesionales.forEach((profesional) => {
        if (profesional.verificado) {
          ...
          card.href = `profesional.html?id=${profesional.id}`;
          ...
          // SVG de la estrella de verificación
          const svgEstrella = document.createElementNS(
            "http://www.w3.org/2000/svg",
            "svg",
          );
          svgEstrella.setAttribute("viewBox", "0 -0.5 32 32");
          svgEstrella.setAttribute("fill", "none");

          const pathEstrella = document.createElementNS(
            "http://www.w3.org/2000/svg",
            "path",
          );
          ...
          pathEstrella.setAttribute("fill", "#FFCB45");

          svgEstrella.append(pathEstrella);

          // Se agregan h3, spanOficio y svgEstrella en orden
          divInfo.append(h3, spanOficio, svgEstrella);
